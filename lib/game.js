...
function Game(obj) {
  ...
  document.addEventListener('keypress', function(event) {
	...
	spritey.position.set(blacksmith.bodyTorso.GetPosition().x*7,blacksmith.bodyTorso.GetPosition().y*-5,0);
	scene.add( spritey );*/
...
var render = function() {
  ...
  var distance = lineDistance(sword.bodySword.GetPosition().x, sword.bodySword.GetPosition().y, 10,10);
