...
Blob.prototype.collideWith = function( creature ){
	console.log( creature );
	if ( creature.fixture == currentScene.player )
	{
		
		this.dealDamage( creature.fixture.userData );
	}
}
...
Blob.prototype.addToUpdate = function(){
	...
	currentScene.updateList.push( createUpdate( function( self ){
		...
		position = fixture.body.GetPosition();
		console.log( position.x, currentScene.player.body.GetPosition().x );
		var force = 2;
		if ( directionFromTo( position.x, currentScene.player.body.GetPosition().x ) == "right" ) {
